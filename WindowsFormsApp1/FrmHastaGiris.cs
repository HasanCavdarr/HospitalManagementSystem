...
namespace WindowsFormsApp1
{
    public partial class FrmHastaGiris : Form
    {
        ...
        {
            FrmHastaSifreUnuttum fr = new FrmHastaSifreUnuttum();
            fr.Eposta = TxtEpostaGiris.Text;
        ...
        {
            SqlCommand komut = new SqlCommand("Select * From Tbl_Hastalar Where HastaEposta=@p1 and HastaSifre=@p2", bgl.baglanti());
            komut.Parameters.AddWithValue("@p1", TxtEpostaGiris.Text);
